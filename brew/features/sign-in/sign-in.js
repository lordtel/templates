...
export function renderSignIn(container, { onGuest } = {}) {
  container.innerHTML = `
    <div class="sign-in">
      ...
      <div class="sign-in-card">
        <p class="sign-in-copy">Sign in to sync across devices. Your data stays secure — only you can see it.</p>
      ...
      <p class="sign-in-footer">You can delete everything anytime.</p>
    </div>
  `;
